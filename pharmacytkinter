...
def open___window():
    ...
    sub_btn =Button(pycharm, font=("Times", 16), text="Submit", width=8,fg="white",command=kiki, bg='royalblue4', activebackground="deeppink", activeforeground="White")
...
btt=Button(root,bg="paleturquoise2",relief=SUNKEN,fg='navy blue',font=("Times",16 ),text="FORM", command=open___window, activebackground="deeppink",activeforeground="white")
...
def open__window():
    root1 = Tk()
    root1.geometry("1360x1500")
    root1.title("Description Window")
    root1.resizable(0,0)


    ff = Frame(root1, bg="royalblue3")
    ...
    bb2.place(x=1100, y=650)
    bb3= Button(root1, bg="paleturquoise", fg="navy", text="FORM", font=("Times", 20), command=open___window)
    bb3.place(x=900, y=650)
...
btn0 = Button(root,bg="paleturquoise2",fg='navy blue', text="   Description   ", activebackground="deeppink",activeforeground="white",relief=SUNKEN,font=("Times",16
...
btn = Button(root, width=30,text="  COST CALCULATOR",fg='navy blue',font=('Times',16), bg="paleturquoise2", relief=SUNKEN, command=cc, activebackground="deeppink",activeforeground="white")
...
def viewitem():
    ...
    f.close()
    txt_result.config(text="Successfully read the data from database", fg="navy", font=("Times",12))#configuring message in label
...
btn_add = Button(Buttons, width=10, text="ADD", command=additem, bg="Azure",fg='navy', font=("Times",12), activebackground="deeppink",activeforeground="white")
btn_add.pack(side=LEFT)
btn_delete = Button(Buttons, width=10, text="Delete", activebackground="deeppink",activeforeground="white", command=deleteitem,bg="Azure",fg='navy', font=("Times",12))
btn_delete.pack(side=LEFT)
btn_update = Button(Buttons, width=10, text="UPDATE", command=updateitem,bg="Azure",fg='navy', font=("Times",12), activebackground="deeppink",activeforeground="white")
btn_update.pack(side=LEFT)
btn_view = Button(Buttons, width=10, text="View", command=viewitem,bg="Azure",fg='navy', font=("Times",12), activebackground="deeppink",activeforeground="white")
btn_view.pack(side=LEFT)
btn_clear = Button(Buttons, width=10, text="CLEAR", command=clearitem,bg="Azure",fg='navy', font=("Times",12), activebackground="deeppink",activeforeground="white")
